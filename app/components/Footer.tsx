        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Группа компаний, специализирующаяся на комплексных технических обследованиях 
              и неразрушающем контроле.
            </p>
            <div className="flex gap-4">
              <a 
                href="https://www.instagram.com/lukosgroupkz/" 
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+77089537178" className="hover:text-white transition-colors text-sm block">
                    +7 (708) 953-71-78
                  </a>
                  <a href="tel:+77752759919" className="hover:text-white transition-colors text-sm block mt-1">
                    +7 (775) 275-99-19
                  </a>
                  <a href="tel:+77782649243" className="hover:text-white transition-colors text-sm block mt-1">
                    +7 (778) 264-92-43
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:lukosgroupkz@gmail.com" className="hover:text-white transition-colors text-sm">
                  lukosgroupkz@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                <a href="https://go.2gis.com/dMrav" className="hover:text-white transition-colors text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm text-center md:text-left">
              © {currentYear} LUKOS GROUP. Все права защищены.
            </p>
